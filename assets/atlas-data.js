(function () {
  ...
  const companyFolios = Object.freeze([
    ...
    makeCompany({ id: "ATLAS-05", name: "Microrredes de continuidad", sector: "Energía", country: "Perú", region: "Operación minera remota", acquisitionYear: 2014, yearsOwned: 12, assetType: "Energía distribuida", description: "Microrredes diseñadas para operaciones que no pueden detenerse.", capabilities: ["Autonomía", "Respaldo", "Ingeniería local"] }),
    ...
    makeCompany({ id: "ATLAS-08", name: "Cadena fría portuaria", sector: "Marítimo & logística", country: "Panamá", region: "Hub refrigerado", acquisitionYear: 2003, yearsOwned: 23, assetType: "Logística alimentaria", description: "Infraestructura de frío que reduce pérdida y protege valor exportable.", capabilities: ["Frío", "Trazabilidad", "Rotación"] }),
    ...
    makeCompany({ id: "ATLAS-12", name: "Depósito intermodal", sector: "Marítimo & logística", country: "Singapur", region: "Asia-Pacífico", acquisitionYear: 2023, yearsOwned: 3, assetType: "Intermodal", description: "Nodo intermodal para redistribución regional de carga crítica.", capabilities: ["Aduana", "Patio", "Velocidad"] }),
    ...
    makeCompany({ id: "ATLAS-15", name: "Servicios geológicos", sector: "Minería & recursos", country: "Australia", region: "Cinturón mineral", acquisitionYear: 2009, yearsOwned: 17, assetType: "Inteligencia técnica", description: "Equipo técnico que reduce incertidumbre antes de desplegar capital.", capabilities: ["Due diligence", "Muestreo", "Modelos geológicos"] }),
  ...
  const englishCompanyCopy = Object.freeze({
    "ATLAS-01": { name: "Andean energy folio", sector: "Energy", country: "Ecuador", region: "Andes · distributed generation", assetType: "Critical generation", description: "Electrical continuity platform for Andean industrial corridors.", capabilities: ["Continuity", "Major maintenance", "Long-term contracts"] },
    ...
    "ATLAS-09": { name: "Harbor tugboats", sector: "Maritime & logistics", country: "Netherlands", region: "Rotterdam", assetType: "Port service", description: "Port-support fleet serving harbors with high operational density.", capabilities: ["Maneuvering", "Safety", "Availability"] },
    ...
    "ATLAS-17": { name: "Circular industrial water", sector: "Mining & resources", country: "Mexico", region: "Industrial desert", assetType: "Water reuse", description: "Water-reuse system for mining operations and heavy manufacturing.", capabilities: ["Treatment", "Recirculation", "Social license"] },
    ...
    "ATLAS-19": { name: "Critical regional fiber", sector: "Infrastructure", country: "Colombia", region: "Secondary cities", assetType: "Connectivity", description: "Regional fiber for cities where redundancy remains scarce.", capabilities: ["Rings", "Last mile", "Enterprise contracts"] },
    "ATLAS-20": { name: "Sovereign data centers", sector: "Infrastructure", country: "United States", region: "Texas", assetType: "Essential computing", description: "Compute capacity for clients requiring local control.", capabilities: ["Energy", "Cooling", "Physical security"] },
